...
int main()
{
	vector<string>
		...
		b = { "word", "world", "row" },
		c = { "apple", "app" };
	OutBool(isAlienSorted(a, "hlabcdefgijkmnopqrstuvwxyz"));
	OutBool(isAlienSorted(b, "worldabcefghijkmnpqstuvxyz"));
	OutBool(isAlienSorted(c, "abcdefghijklmnopqrstuvwxyz"));
}
