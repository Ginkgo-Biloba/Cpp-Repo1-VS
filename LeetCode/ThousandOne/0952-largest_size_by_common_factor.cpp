...
int main()
{
	...
	Solution s;
	OutExpr(s.largestComponentSize(a), "%d");
	OutExpr(s.largestComponentSize(b), "%d");
	OutExpr(s.largestComponentSize(c), "%d");
	OutExpr(s.largestComponentSize(d), "%d");
	OutExpr(s.largestComponentSize(e), "%d");
}
