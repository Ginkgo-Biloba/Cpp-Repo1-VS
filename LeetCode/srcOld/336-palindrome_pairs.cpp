...
// https://leetcode.com/problems/palindrome-pairs/discuss/79215/Easy-to-understand-AC-C%2B%2B-solution-O(n*k^2)-using-map
// 抄的，假定没有相同的字符串
bool isPalindrome(string str)
{
	ptrdiff_t i = 0, j = str.size() - 1;
