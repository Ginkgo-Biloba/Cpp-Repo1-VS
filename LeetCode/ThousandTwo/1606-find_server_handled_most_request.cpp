...
int main()
{
	vector<int>
		...
		i = { 1 }, j = { 1 };
	output(busiestServers(3, a, b), "Server");
	output(busiestServers(3, c, d), "Server");
	output(busiestServers(3, e, f), "Server");
	output(busiestServers(3, g, h), "Server");
	output(busiestServers(3, i, j), "Server");
}
