...
int main()
{
	output(allCellsDistOrder(1, 2, 0, 0), "Matrix Cells in Distance Order");
	output(allCellsDistOrder(2, 2, 0, 1), "Matrix Cells in Distance Order");
	output(allCellsDistOrder(2, 3, 1, 2), "Matrix Cells in Distance Order");
}
