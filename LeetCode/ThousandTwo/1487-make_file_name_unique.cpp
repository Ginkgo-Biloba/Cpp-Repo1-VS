...
int main()
{
	...
	output(getFolderNames(a), ", ", "Folder");
	output(getFolderNames(b), ", ", "Folder");
	output(getFolderNames(c), ", ", "Folder");
	output(getFolderNames(d), ", ", "Folder");
	output(getFolderNames(e), ", ", "Folder");
}
