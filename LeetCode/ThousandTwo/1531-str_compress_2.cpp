...
{
	Solution s;
	OutExpr(s.getLengthOfOptimalCompression("aaabcccd", 2), "%d");
	OutExpr(s.getLengthOfOptimalCompression("aabbaa", 2), "%d");
	OutExpr(s.getLengthOfOptimalCompression("aaaaaaaaaaa", 0), "%d");
}
