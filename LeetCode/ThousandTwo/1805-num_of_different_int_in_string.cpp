...
int main()
{
	OutExpr(numDifferentIntegers("u"), "%d");
	OutExpr(numDifferentIntegers("a123bc34d8ef34"), "%d");
	OutExpr(numDifferentIntegers("leet1234code234"), "%d");
	OutExpr(numDifferentIntegers("a1b01c001"), "%d");
}
