...
int main()
{
	vector<int>
		...
		d = { 6, -3, 7, 2, 11 },
		e = { -7, 22, 17, 3 };
	output(getStrongest(a, 2), "k strong");
	output(getStrongest(b, 2), "k strong");
	output(getStrongest(c, 5), "k strong");
	output(getStrongest(d, 3), "k strong");
	output(getStrongest(e, 2), "k strong");
}
