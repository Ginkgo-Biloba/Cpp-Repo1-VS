...
int main()
{
	OutBool(areSentencesSimilar("My name is Haley", "My Haley"));
	OutBool(areSentencesSimilar("of", "A lot of words"));
	OutBool(areSentencesSimilar("Eating right now", "Eating"));
	OutBool(areSentencesSimilar("Luky", "Lucccky"));
}
