...
int main()
{
	vector<int>
		...
		d = { 7, 7, 7, 7, 7, 7, 7 },
		e = { 4, 4, 4, 4 };
	OutExpr(numOfSubarrays(a, 3, 4), "%d");
	OutExpr(numOfSubarrays(b, 1, 0), "%d");
	OutExpr(numOfSubarrays(c, 3, 5), "%d");
	OutExpr(numOfSubarrays(d, 7, 7), "%d");
	OutExpr(numOfSubarrays(e, 4, 1), "%d");
}
