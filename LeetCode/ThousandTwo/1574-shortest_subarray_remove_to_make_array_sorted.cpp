...
int main()
{
	vector<int>
		...
		c = { 1, 2, 3 },
		d = { 1 };
	OutExpr(findLengthOfShortestSubarray(a), "%d");
	OutExpr(findLengthOfShortestSubarray(b), "%d");
	OutExpr(findLengthOfShortestSubarray(c), "%d");
	OutExpr(findLengthOfShortestSubarray(d), "%d");
}
