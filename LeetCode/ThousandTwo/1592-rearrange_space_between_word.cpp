...
int main()
{
	OutString(reorderSpaces("  this   is  a sentence "));
	OutString(reorderSpaces(" practice   makes   perfect"));
	OutString(reorderSpaces("hello   world"));
	OutString(reorderSpaces("  walks  udp package   into  bar a"));
	OutString(reorderSpaces("a "));
}
