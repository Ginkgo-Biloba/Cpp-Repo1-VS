...
{
	Solution s;
	OutBool(s.checkPalindromeFormation("x", "y"));
	OutBool(s.checkPalindromeFormation("abdef", "fecab"));
	OutBool(s.checkPalindromeFormation("ulacfd", "jizalu"));
	OutBool(s.checkPalindromeFormation("xbdef", "xecab"));
	OutBool(s.checkPalindromeFormation(
