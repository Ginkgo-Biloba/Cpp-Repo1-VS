...
[Buildings Skyline Contour](https://assets.leetcode-cn.com/aliyun-lc-upload/uploads/2018/10/22/skyline1.png)
...
int main()
{
	...
	output(getSkyline(buildings), "The Skyline Problem");
}
